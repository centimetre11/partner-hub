    ...
    <div className="pb-16">
      ...
      <div className="px-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <Card title={m.framework.positioningPlaybook}>
            <dl className="space-y-3 text-sm">
              <div>
                <dt className="text-xs font-semibold text-indigo-700">{m.framework.positioning}</dt>
                <dd className="text-zinc-600 mt-1">{m.framework.positioningDesc}</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold text-indigo-700">{m.framework.playbook}</dt>
                <dd className="text-zinc-600 mt-1">{m.framework.playbookDesc}</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold text-indigo-700">{m.framework.actions}</dt>
          ...
          <Card title={m.framework.archetypeBranch}>
            ...
            <p className="text-xs text-zinc-400 mt-3">{m.framework.archetypeNote}</p>
          </Card>
        </div>
        ...
        <Card title={m.framework.valuePatterns}>
          ...
          <p className="text-xs text-zinc-500 mt-4">{m.framework.valuePatternsNote}</p>
        </Card>
