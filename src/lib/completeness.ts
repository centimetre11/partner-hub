...
const CHECKS: Check[] = [
  ...
  { label: "Current BI tools", weight: 5, ok: (p) => !!p.currentTools },
  { label: "Certification level", weight: 4, ok: (p) => !!p.certLevel },
  { label: "Key differentiator", weight: 5, ok: (p) => !!p.keyDifferentiator },
  ...
  { label: "BD owner", weight: 5, ok: (p) => !!p.ownerId },
