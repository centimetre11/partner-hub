...
const TOOL_DESCS: Record<string, string> = {
  ...
  create_todo: "Create a todo item, optionally linked to a partner with a due date",
  update_todo: "Update an existing todo (assignee, due date, title, priority, detail)",
  list_todos: "View open or overdue todo items",
  list_opportunities: "List sales opportunities for a partner",
  update_opportunity: "Update an existing opportunity",
  list_business_records: "List recent business records for a partner",
  ...
  add_timeline_event: "Record external signals/news on a partner timeline (applied directly, audited)",
...
const TOOL_DESCS_ZH: Record<string, string> = {
  ...
  create_todo: "创建待办，可关联伙伴并设置截止日期",
  update_todo: "更新已有待办（负责人、截止日期、标题、优先级、详情）",
  list_todos: "查看进行中或逾期的待办",
  list_opportunities: "列出某伙伴的销售商机",
  update_opportunity: "更新已有商机",
  list_business_records: "列出某伙伴最近的商务记录",
  linkedin_search: "搜索 LinkedIn 公司主页、高管动态与公开职业信息（监控关键联系人）",
  web_search: "搜索公开新闻、招聘、获奖、竞品动态（非 LinkedIn 场景）",
  add_timeline_event: "在伙伴时间线上记录外部信号/新闻（直接写入并审计）",
